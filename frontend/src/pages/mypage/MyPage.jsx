...
function MyPage() {
  ...
  const handleCosmeticEdit = () => {
    const category = isCosmeticClicked === "맞는 화장품" ? "suitableCosmetics" : "unsuitableCosmetics"

    setEditPopupProps({
      type: "cosmetics",
      suitability: isCosmeticClicked === "맞는 화장품" ? "suitable" : "unsuitable",
      category: category,
  ...
  const handleIngredientEdit = () => {
    const category = isIngredientClicked === "맞는 성분" ? "suitableIngredients" : "unsuitableIngredients"
      ...
      <div className="wrapper">
        ...
        <div className="edit-user-info">
          ...
          <div>
            ...
            {isMyInfoOpen && <PwCheckPopUp onClose={handlePwPopup} state="myinfo" />}
          </div>
        </div>
        ...
        <div className="cosmetic-wrapper">
          ...
          <div className="set-position">
            <ToggleButton text1="맞는 화장품" text2="맞지 않는 화장품" handler={cosmeticHandler} />
          ...
          {/* 조건부 렌더링 및 map() */}
          {(isCosmeticClicked === "화장품" ? myMatchedCosData : myUnMatchedCosData)?.map((cos) => (
        ...
        <div className="my-ingredient-box">
          <h2>내가 등록한 성분</h2>
          <div className="set-position">
            <ToggleButton text1="맞는 성분" text2="맞지 않는 성분" handler={ingredientHandler} />
            <button className="edit-del-btn" onClick={handleIngredientEdit}>
              수정
            </button>
          </div>
          {(isIngredientClicked === "맞는 성분" ? myMatchedIngreData : myUnMatchedIngreData)?.map((ing) => (
            <div key={ing.id}>
